    ...
    <#elseif section = "form">
        <form id="kc-update-profile-form" class="${properties.kcFormClass!}" action="${url.loginAction}" method="post">
            ...
            <div class="form-group">
                ...
                <div class="${properties.kcInputWrapperClass!}">
                    <input type="text" class="${properties.kcInputClass!}"  id="user.attributes.phone_number" name="user.attributes.phone_number" value="${(user.attributes.phone_number!'')?html}"/>
                </div>
            </div>
