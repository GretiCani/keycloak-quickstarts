        ...
        <form id="kc-register-form" class="${properties.kcFormClass!}" action="${url.registrationAction}" method="post">
          ...
          <#if !realm.registrationEmailAsUsername>
            ...
            <div class="form-group">
                <div class="${properties.kcLabelWrapperClass!}">
                    <label for="user.attributes.phone_number" class="${properties.kcLabelClass!}">${msg("phone_number")}</label>
                </div>

                <div class="${properties.kcInputWrapperClass!}">
                    <input type="text" class="${properties.kcInputClass!}"  id="user.attributes.phone_number" name="user.attributes.phone_number" value="${(register.formData['user.attributes.phone_number']!'')?html}"/>
                </div>
            </div>
